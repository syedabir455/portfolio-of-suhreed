    ...
    <div className="container mx-auto flex">
      <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12'>
        <div className='flex-1 text-center font-secondary lg:text-left'><motion.h1
          ...
          initial="hidden"
          whileInView={'show'}
          viewport={{ once: false, amount: 0.7 }} className='text-[55px] font-bold leading-[0.8] lg:text-[110px]'>SUHREED <span>ASLAM</span></motion.h1>
          <motion.div
          ...
          <motion.p variants={fadeIn('up', 0.5)}
            initial="hidden"
            whileInView={'show'}
            viewport={{ once: false, amount: 0.7 }} className='mb-8 max-w-lg mx-auto lg:mx-0'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate voluptate iure aperiam laudantium nostrum tenetur ratione veritatis. Expedita nesciunt ea a, officia consequatur debitis minus eaque et! Laborum, possimus harum!</motion.p>
          <motion.div
      ...
      whileInView={'show'} 
      viewport={{once:false,amount:0.7}} 
      className='hidden lg:flex flex-1 max-w-[320px] lg:max-w-[482px] '><img className='rounded-lg' src={Image} alt="" /></motion.div>
    </div>
  </section>;
};
